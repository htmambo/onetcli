...
fn effective_terminal_theme(theme: &TerminalTheme, _cx: &App) -> TerminalTheme {
    theme.clone()
}
...
if should_reset_history_prompt_for_terminal_event(event) {
    ...
    fn write_to_pty(&mut self, data: Vec<u8>, cx: &mut Context<Self>) {
        ...
        self.terminal.read(cx).write_user_input(&data);
    }
...
#[test]
    ...
    #[test]
    fn history_prompt_disables_in_terminal_application_mode() {
