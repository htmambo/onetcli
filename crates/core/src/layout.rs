...
use gpui_component::tokens::spacing::{
    CHAT_SIDEBAR_MAX_WIDTH as CHAT_SIDEBAR_MAX_VAL, CHAT_SIDEBAR_MIN_WIDTH as CHAT_SIDEBAR_MIN_VAL,
    CHAT_SIDEBAR_WIDTH, PANEL_MIN_SIZE as PANEL_MIN_SIZE_VAL, SIDEBAR_MAX_WIDTH as SIDEBAR_MAX_VAL,
    SIDEBAR_MIN_WIDTH as SIDEBAR_MIN_VAL, SIDEBAR_WIDTH, TITLE_BAR_HEIGHT as TITLE_BAR_HEIGHT_VAL,
    TOOLBAR_BUTTON_SIZE as TOOLBAR_BUTTON_SIZE_VAL, TOOLBAR_HEIGHT,
    TREE_PANEL_MAX_WIDTH as TREE_PANEL_MAX_VAL, TREE_PANEL_MIN_WIDTH as TREE_PANEL_MIN_VAL,
    TREE_PANEL_WIDTH,
};
...
/// 工具栏按钮尺寸
pub const TOOLBAR_BUTTON_SIZE: Pixels = px(TOOLBAR_BUTTON_SIZE_VAL);
/// 标题栏高度
pub const TITLE_BAR_HEIGHT: Pixels = px(TITLE_BAR_HEIGHT_VAL);
